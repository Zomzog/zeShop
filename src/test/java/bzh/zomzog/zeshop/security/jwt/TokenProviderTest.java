package bzh.zomzog.zeshop.security.jwt;
...
public class TokenProviderTest {
    ...
    public void testReturnFalseWhenJWThasInvalidSignature() {
        final boolean isTokenValid = tokenProvider.validateToken(createTokenWithDifferentSignature());
    ...
    public void testReturnFalseWhenJWTisMalformed() {
        ...
        final boolean isTokenValid = tokenProvider.validateToken(invalidToken);
    ...
    public void testReturnFalseWhenJWTisExpired() {
        ...
        final boolean isTokenValid = tokenProvider.validateToken(token);
    ...
    public void testReturnFalseWhenJWTisUnsupported() {
        ...
        final boolean isTokenValid = tokenProvider.validateToken(unsupportedToken);
    ...
    public void testReturnFalseWhenJWTisInvalid() {
        ...
        final boolean isTokenValid = tokenProvider.validateToken("");
