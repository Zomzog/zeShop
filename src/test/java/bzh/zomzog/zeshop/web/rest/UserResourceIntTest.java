...
import bzh.zomzog.zeshop.service.UserService;
import bzh.zomzog.zeshop.web.rest.errors.ExceptionTranslator;
import bzh.zomzog.zeshop.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void setup() {
        ...
        final UserResource userResource = new UserResource(userRepository, mailService, userService);
    ...
    public void createUser() throws Exception {
        ...
        final ManagedUserVM managedUserVM = new ManagedUserVM(null, DEFAULT_LOGIN, DEFAULT_PASSWORD, DEFAULT_FIRSTNAME,
    ...
    public void createUserWithExistingId() throws Exception {
        ...
        final Set<String> autorities = new HashSet<>();
        autorities.add("ROLE_USER");
        final ManagedUserVM managedUserVM = new ManagedUserVM(1L, DEFAULT_LOGIN, DEFAULT_PASSWORD, DEFAULT_FIRSTNAME,
                DEFAULT_LASTNAME, DEFAULT_EMAIL, true, DEFAULT_IMAGEURL, DEFAULT_LANGKEY, null, null, null, null,
                autorities);
    ...
    public void createUserWithExistingLogin() throws Exception {
        ...
        final Set<String> autorities = new HashSet<>();
        autorities.add("ROLE_USER");
        final ManagedUserVM managedUserVM = new ManagedUserVM(null, DEFAULT_LOGIN, // this
                                                                                   // login
                                                                                   // should
                                                                                   // already
                                                                                   // be
                ...
                DEFAULT_LANGKEY, null, null, null, null, autorities);
    ...
    public void createUserWithExistingEmail() throws Exception {
        ...
        final Set<String> autorities = new HashSet<>();
        autorities.add("ROLE_USER");
        final ManagedUserVM managedUserVM = new ManagedUserVM(null, "anotherlogin", DEFAULT_PASSWORD, DEFAULT_FIRSTNAME,
                DEFAULT_LASTNAME, DEFAULT_EMAIL, // this email should already be
                                                 // used
                true, DEFAULT_IMAGEURL, DEFAULT_LANGKEY, null, null, null, null, autorities);
    ...
    public void updateUserExistingLogin() throws Exception {
        ...
        final Set<String> autorities = new HashSet<>();
        autorities.add("ROLE_USER");
        final ManagedUserVM managedUserVM = new ManagedUserVM(updatedUser.getId(), "jhipster", // this
                                                                                               // login
                                                                                               // should
                                                                                               // already
                                                                                               // be
