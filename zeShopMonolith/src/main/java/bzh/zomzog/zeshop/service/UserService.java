...
import bzh.zomzog.zeshop.service.util.RandomUtil;
...
public class UserService {
    ...
    public UserService(final UserRepository userRepository, final PasswordEncoder passwordEncoder,
            final SocialService socialService, final AuthorityRepository authorityRepository) {
    ...
    public User createUser(final String login, final String password, final String firstName, final String lastName,
            final String email, final String imageUrl, final String langKey) {
     ...
     * current user.
     */
    public void updateUser(final String firstName, final String lastName, final String email, final String langKey) {
