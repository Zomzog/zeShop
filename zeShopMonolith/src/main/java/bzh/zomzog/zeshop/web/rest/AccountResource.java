...
import bzh.zomzog.zeshop.security.SecurityUtils;
...
import bzh.zomzog.zeshop.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    @Timed
    public ResponseEntity<String> registerAccount(@Valid @RequestBody final ManagedUserVM managedUserVM) {
        ...
        return userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase())
                ...
                .orElseGet(() -> userRepository.findOneByEmail(managedUserVM.getEmail())
                        ...
                        .orElseGet(() -> {
                            final User user = userService.createUser(managedUserVM.getLogin(),
    ...
    @PostMapping("/account")
    @Timed
    public ResponseEntity<String> saveAccount(@Valid @RequestBody final UserDTO userDTO) {
    ...
    @Timed
    public ResponseEntity<String> changePassword(@RequestBody final String password) {
    ...
    @Timed
    public ResponseEntity<String> requestPasswordReset(@RequestBody final String mail) {
    ...
    @Timed
    public ResponseEntity<String> finishPasswordReset(@RequestBody final KeyAndPasswordVM keyAndPassword) {
