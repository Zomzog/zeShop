...
import bzh.zomzog.zeshop.security.AuthoritiesConstants;
...
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        final AccountResource accountResource = new AccountResource(userRepository, userService, mockMailService);

        final AccountResource accountUserMockResource = new AccountResource(userRepository, mockUserService,
                mockMailService);
    ...
    public void testRegisterValid() throws Exception {
        final ManagedUserVM validUser = new ManagedUserVM(null, // id
                "joe", // login
                "password", // password
                "Joe", // firstName
                "Shmoe", // lastName
    ...
    public void testRegisterInvalidLogin() throws Exception {
        final ManagedUserVM invalidUser = new ManagedUserVM(null, // id
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        final ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(),
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        final ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), "johnjr", validUser.getPassword(),
    ...
    public void testSaveInvalidLogin() throws Exception {
        final UserDTO invalidUser = new UserDTO(null, // id
                "funky-log!n", // login <-- invalid
                "Funky", // firstName
                "One", // lastName
                "funky@example.com", // e-mail
